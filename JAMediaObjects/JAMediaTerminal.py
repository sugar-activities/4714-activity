...
class NoteBookTerminal(Gtk.Notebook):
    ...
    def __init__(self):
        ...
        self.fuente = Pango.FontDescription("Monospace %s" % 8)
    ...
    def agregar_terminal(self, path = os.environ["HOME"],
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Cerrar")
...
class Terminal(Vte.Terminal):
    ...
    def __init__(self,
        ...
        interprete = "/bin/bash",
        archivo = None,
        fuente = Pango.FontDescription("Monospace %s" % 8)):
...
class ToolbarTerminal(Gtk.Toolbar):
    ...
    def __init__(self):
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Copiar")
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Pegar")
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Fuente")
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Nueva Terminal")
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Terminal bash")
        ...
        boton = get_boton(archivo,
            pixels = get_pixels(Width_Button*2), tooltip_text = "Terminal python")
